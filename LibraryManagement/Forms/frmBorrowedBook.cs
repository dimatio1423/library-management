...
namespace LibraryManagement
{
    public partial class frmBorrowedBook : Form
    {
        ...
        private void updateToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //check preStatus
            BorrowRecord borrowBook = borrowBookRepository.GetBorrowRecord(int.Parse(txtRecordId.Text));

            string preStatus = borrowBook.ReturnStatus;
            //
            ...
            else
            {
                ...
                if (!preStatus.Equals(returnStatus))
                {
