    ...
    public partial class frmRegisterPublisher : Form
    {
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (publisherList.Any(a => a.PublisherName == publisher.PublisherName && a.Address == publisher.Address))
                {
                    MessageBox.Show("Nhà xuất bản đã tồn tại.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    refresh();
                    return;
                }
